...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.sandboxOff": "Sandbox off — click to run new sessions in a throwaway worktree",
    ...
    "sidebar.hideGroup": "Hide this group from the sidebar",
    "sidebar.gitHistory": "Show git commit history",
    "explorer.gitHistoryLoading": "Loading commits…",
    "explorer.gitHistoryEmpty": "No commits here (or this is not a git repository)",
    "explorer.gitHistoryCopied": "Copied",
    "explorer.gitHistoryCopy": "Copy full hash: {hash}",
    "explorer.gitHistoryUnavailable": "Commit history unavailable (not a git repository?)",
    "sidebar.showHidden": "Show {count} hidden project(s)",
    "sidebar.showHiddenTitle": "Show the projects you hid again",
