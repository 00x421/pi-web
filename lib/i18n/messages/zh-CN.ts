...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.sandboxOff": "沙箱：关闭（点击后新会话在一次性工作树里运行）",
    ...
    "sidebar.hideGroup": "从侧边栏隐藏该组",
    "sidebar.gitHistory": "查看 git 提交记录",
    "explorer.gitHistoryLoading": "正在读取提交记录…",
    "explorer.gitHistoryEmpty": "这个目录没有提交记录（或不是 git 仓库）",
    "explorer.gitHistoryCopied": "已复制",
    "explorer.gitHistoryCopy": "复制完整 hash：{hash}",
    "explorer.gitHistoryUnavailable": "读不到提交记录（不是 git 仓库？）",
    "sidebar.showHidden": "显示已隐藏的 {count} 个项目",
    "sidebar.showHiddenTitle": "把隐藏的项目重新显示出来",
