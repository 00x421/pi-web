...
export const zhTWLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "sidebar.sandboxOff": "沙箱：關閉（點擊後新工作階段在一次性工作樹裡執行）",
    ...
    "sidebar.hideGroup": "從側邊欄隱藏此組",
    "sidebar.gitHistory": "檢視 git 提交記錄",
    "explorer.gitHistoryLoading": "正在讀取提交記錄…",
    "explorer.gitHistoryEmpty": "此目錄沒有提交記錄（或不是 git 儲存庫）",
    "explorer.gitHistoryCopied": "已複製",
    "explorer.gitHistoryCopy": "複製完整 hash：{hash}",
    "explorer.gitHistoryUnavailable": "讀不到提交記錄（不是 git 儲存庫？）",
    "sidebar.showHidden": "顯示已隱藏的 {count} 個專案",
    "sidebar.showHiddenTitle": "把隱藏的專案重新顯示出來",
    ...
    "chat.dropResolving": "正在解析拖入的檔案…",
    "chat.docExtracted": "已擷取文件內容（{chars} 字）",
    "chat.docExtractedTruncated": "已擷取文件內容（{chars} 字，超出部分已截斷）",
