      ...
      {isStreaming ? (
        ...
        <SyntaxHighlighter
          ...
          customStyle={{
            ...
            lineHeight: 1.62,
            borderRadius: 0,
            // Longhand on purpose: the prism themes set `backgroundColor` on this
            // same element, and mixing the shorthand with it makes React warn
            // when the theme changes and one of the two is dropped.
